...
class sendpush extends AsyncTask<Void, Void, Void>{
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            Log.e("task",receiver);
            reference = FirebaseDatabase.getInstance().getReference("Tokens").child(receiver).child("TokenUid");
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
...
//                    try {
//                        info.put("title","[Together Talk]");
//                        info.put("body","새로운 메세지 알림이 있습니다.");
//
//                        input.put("notification",info);
//                        input.put("to",tokenKey.get("token").toString());
//                        Log.e("input",input+"");
//                    } catch (JSONException e) {
//                        e.printStackTrace();
//                    }
                        String input = "{\"notification\" : {\"title\" : \"[Together] \", \"body\" : \"예약이 완료되었습니다.\"}, \"to\":\""+tokenKey.get("token").toString()+"\"}";
...
//
                        ...
                        wr.write(String.valueOf(input.getBytes("UTF-8")));
