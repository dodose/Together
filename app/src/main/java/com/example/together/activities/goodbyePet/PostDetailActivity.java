...
import com.example.together.adapter.MemorialCommentAdapter;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    MemorialCommentAdapter memorialCommentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        btnAddComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MemorialComment comment = new MemorialComment(comment_content,uid,uimg,uname);
    ...
    private void iniRvComment() {
        ...
        commentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                memorialCommentAdapter = new MemorialCommentAdapter(getApplicationContext(),listComment);
                RvComment.setAdapter(memorialCommentAdapter);
